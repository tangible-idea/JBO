...
공통으로 전체 북마크 또는 특정 폴더 안만 정리할 수 있습니다. 서버는 각 북마크의 페이지 제목과 메타 설명·키워드·사이트 이름을 읽어 분류합니다. 결과는 목적지 폴더별로 묶인 이동 예정표로 보여 줍니다. 항목마다 목적지를 바꿀 수 있고, 확신도가 기준 이하인 항목은 ‘검토 필요’로 표시되어 기본 선택에서 빠집니다. 적용 전에는 아무것도 바뀌지 않으며, 마지막 정리는 되돌릴 수 있습니다.
